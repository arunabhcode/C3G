...
Smoke test (first scene on the volume)::
    ...
    modal run src/modal_infra/modal_precompute_sam_features.py::smoke --dataset replica
    modal run src/modal_infra/modal_precompute_sam_features.py::smoke --dataset scannet --wait

Full precompute (detached by default; pass ``--wait`` to block locally)::

    modal run --detach src/modal_infra/modal_precompute_sam_features.py::main --dataset replica
    modal run --detach src/modal_infra/modal_precompute_sam_features.py::main --dataset scannet
    modal run src/modal_infra/modal_precompute_sam_features.py::main --dataset scannet --wait
