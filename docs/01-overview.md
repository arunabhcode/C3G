...
│   │   ├── model_wrapper.py    # LightningModule (training/test logic)
│   │   ├── load_foundation_model.py  # VFM loading dispatch
│   │   └── types.py            # Gaussians dataclass
│   └── visualization/          # Rendering, annotation, camera trajectories
├── assets/                     # Evaluation indices, teaser image
