...
Modal: [`src/modal_infra/modal_precompute_sam_features.py`](../src/modal_infra/modal_precompute_sam_features.py)
...
**Modal eval:** [`src/modal_infra/modal_eval_masks.py`](../src/modal_infra/modal_eval_masks.py)
...
| Modal train | [`src/modal_infra/modal_train_c3gsam.py`](../src/modal_infra/modal_train_c3gsam.py) |
